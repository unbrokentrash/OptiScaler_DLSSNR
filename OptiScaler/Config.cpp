...
bool Config::Reload(std::filesystem::path iniPath)
{
    ...
    if (ini.LoadFile(iniPath.c_str()) == SI_OK)
    {
        ...
        // DLSS
        {
            ...
            DlssNrCompose.set_from_config(readUInt("DlssNr", "Compose"));
            DlssNrProbeSignal.set_from_config(readBool("DlssNr", "ProbeSignal"));
            DlssNrWriteBackColour.set_from_config(readBool("DlssNr", "WriteBackColour"));
...
bool Config::SaveIni()
{
    ...
    ini.SetValue("DlssNr", "BeforeUpscale",
                 GetBoolValue(Instance()->DlssNrBeforeUpscale.value_for_config()).c_str());
    {
        auto abKey = Instance()->DlssNrAbCaptureKey.value_for_config();
        ini.SetValue("DlssNr", "AbCaptureKey", GetIntValue(abKey, abKey > 0).c_str());
    }
    ...
    ini.SetValue("DlssNr", "Compose", GetIntValue(Instance()->DlssNrCompose.value_for_config()).c_str());
    ini.SetValue("DlssNr", "ProbeSignal",
                 GetBoolValue(Instance()->DlssNrProbeSignal.value_for_config()).c_str());
    ini.SetValue("DlssNr", "WriteBackColour",
                 GetBoolValue(Instance()->DlssNrWriteBackColour.value_for_config()).c_str());
    ...
    ini.SetValue("DlssNr", "InputAccumAlpha",
                 GetFloatValue(Instance()->DlssNrInputAccumAlpha.value_for_config()).c_str());
    ini.SetValue("DlssNr", "MvScaleMode",
                 GetIntValue(Instance()->DlssNrMvScaleMode.value_for_config()).c_str());
