...
bool Config::Reload(std::filesystem::path iniPath)
{
    ...
    if (ini.LoadFile(iniPath.c_str()) == SI_OK)
    {
        ...
        // DLSS
        {
            ...
            DlssNrAbCaptureMatched.set_from_config(readBool("DlssNr", "AbCaptureMatched"));
            DlssNrCaptureHdr.set_from_config(readUInt("DlssNr", "CaptureHdr"));
...
bool Config::SaveIni()
{
    ...
    ini.SetValue("DlssNr", "AbCaptureMatched",
                 GetBoolValue(Instance()->DlssNrAbCaptureMatched.value_for_config()).c_str());
    ini.SetValue("DlssNr", "CaptureHdr", GetIntValue(Instance()->DlssNrCaptureHdr.value_for_config()).c_str());
